...
pcall(table.insert,t,10,'ten');  print( #t )
...
pcall(table.insert,t,10,'ten');  print( eles(t), #t )
print( '#{}', #{} )
print( '#{"a"}', #{"a"} )
print( '#{"a","b"}', #{"a","b"} )
print( '#{"a",nil}', #{"a",nil} )
...
do local ok,r = pcall(table.remove,t,10); if ok then print( 'table.remove(t,10)', r ) else print( 'table.remove(t,10)' ) end end; print( eles(t), #t )
do local ok,r = pcall(table.remove,t,-1); if ok then print( 'table.remove(t,-1)', r ) else print( 'table.remove(t,-1)' ) end end; print( eles(t), #t )
do local ok,r = pcall(table.remove,t,-1); if ok then print( 'table.remove(t,-1)', r ) else print( 'table.remove(t,-1)' ) end end; print( eles(t), #t )
